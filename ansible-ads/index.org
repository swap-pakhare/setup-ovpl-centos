...
deploy and test the lab. This document presents the procedure on how
the ADS service is ansiblised.
...
#+CAPTION:  Steps Involved in Deploying a Lab
#+LABEL:  Steps Involved in Deploying a Lab
#+NAME:  Steps Involved in Deploying a Lab
