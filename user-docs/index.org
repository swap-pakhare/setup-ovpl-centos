...
For setting up OVPL on CentOS, you are expected to know how to execute [[https://github.com/vlead/setup-ovpl-centos/blob/master/user-docs/faq.org][basic shell commands]] in CentOS 6.5, create and delete a container in OpenVZ virtual environment, create or modify an HTML page and write a code in JavaScript. Here is a quick review material for [[http://www.w3schools.com/html/][HTML]] and [[http://www.w3schools.com/js/][JavaScript]] tutorials.
