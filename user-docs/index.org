...
As an integration engineer, you are expected to know how to use GitHub - a subversioning tool. Here is a small tutorial to revise your concepts about GitHub. [[https://github.com/vlead/setup-ovpl-centos/blob/master/user-docs/version-control.org][Version Control Basics and GitHub]]

A quick introduction and review of virtualization using openVZ can be found at  [[./intro-to-openvz.org][Introduction to OpenVZ]]
