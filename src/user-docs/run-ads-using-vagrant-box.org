...
* Steps to run =ADS= service
  ...
  13. Run =ads-web-app= service
      #+BEGIN_SRC 
      cd /root/ovpl/src/ads-web-app/
      python app.py &
      #+END_SRC
  14. Access =ADS= on browser
  ...
  15. Download more =openvz= templates 
  ...
  16. To create =openvz= template refer [[https://github.com/vlead/vlead-templates/blob/develop/openvz-templates/index.org#introduction][link]]
